...
class ReportController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($validator->fails()) {
                // $model = (new Report)->with(['items.media'])->first();
            ...
            return redirect()->back()->withErrors(['გაურკვეველი შეცდომა!'])->withInput();
        }

        return redirect()->route('reports.index')->withSuccess('მონაცემები განახლდა წარმატებით');
    }
    ...
    public function edit($id)
    {
        ...
        return view('reports.modify', ['model' => $model, 'additional' => $additional]);
    }
