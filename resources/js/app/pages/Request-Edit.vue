  ...
  export default {
    ...
    methods: {
      ...
      removeRequest (model, setting, callback, isReserve=null) {
        ...
        return this.$http.delete(`${setting.url.nested.destroy.replace('__id__', isNew)}`, { data: { reserve: isReserve, evaluation }}, {
      ...
      findSpecialAtribute (res) {
        ...
        if (res == 'new') {
          ...
          existInSpeciail.pivot = {
            ...
            evaluation_price: Util.itemReportValue(existInSpeciail.price, this.initReporteValues),
            is_special : true,
            category_attribute_id: res.id,
            service_price: existInSpeciail.service_price,
            evaluation_service_price: Util.itemReportValue(existInSpeciail.service_price, this.initReporteValues),
          ...
          this.m.category_attributes.push({
            ...
            pivot: { 
              qty: 1,
              price: res.price,
              evaluation_price: Util.itemReportValue(res.price, this.initReporteValues),
              category_attribute_id: res.id,
              service_price: res.service_price,
              evaluation_service_price: Util.itemReportValue(res.service_price, this.initReporteValues),
