...
@page {
  ...
  <body style="padding:0.5cm;">
    ...
    <header class="clearfix">
      ...
      <div id="client" style="width:57%; word-wrap: break-word; border: 1px solid #fff;">
        ...
        <tbody>
          ...
          @foreach ($model['category_attributes'] as $key => $item)
            ...
            <tr>
                ...
                <td style="text-align:right;"class="unit">{{number_format($item['pivot']['price'] , 2, '.', '')}}</td>
                <td style="text-align:right"class="unit">{{number_format($item['pivot']['service_price'] , 2, '.', '')}}</td>
                <td style="text-align:center" class="total">{{number_format($item['pivot']['calc'] , 2, '.', '')}} ლ</td>
            </tr>
